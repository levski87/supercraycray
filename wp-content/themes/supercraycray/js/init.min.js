...
+function(a){"use strict";a("#gallery a,.image a:has(.fa-search-plus),.da-thumbs a:not(.link-to-attachment-page),a[data-lightbox]").nivoLightbox({effect:"fadeScale"})}(jQuery);
