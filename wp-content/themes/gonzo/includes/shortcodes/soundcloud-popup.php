...
var soundcloudDialog = {
	local_ed : 'ed',
	init : function(ed) {
		soundcloudDialog.local_ed = ed;
		tinyMCEPopup.resizeToInnerSize();
	},
	insert : function insertsoundcloud(ed) {
	 
		// Try and remove existing style / blockquote
		tinyMCEPopup.execCommand('mceRemoveNode', false, null);
		 
		// set up variables to contain our input values 
		var sc_url = jQuery('input#sc_url').val();					 	 
				 	 
		 
		var output = '';		
		
		output = '[soundcloud params="auto_play=true&show_comments=true&color=0ac4ff"]'+sc_url+'[/soundcloud]';		
...
<body>
	<div id="button-dialog">
		<form action="/" method="get" accept-charset="utf-8">
				<label for="sc-text">Soundcloud URL</label>
				<input type="text" name="sc-text" value="" id="sc_url" />
			</div>
			<div>	
				<a href="javascript:soundcloudDialog.insert(soundcloudDialog.local_ed)" id="insert" style="display: block; line-height: 24px;">Insert</a>
			</div>
		</form>
	</div>
</body>
