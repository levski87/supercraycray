...
if (!class_exists('SocialBoxConnector')) {
    ...
    class SocialBoxConnector
    {
         ...
         */
        const GOOGLEPLUS_API_BASE = "https://www.googleapis.com/plus/v1/people/";
        ...
        public static function getTwitterData($twitterId, $urlIdentifier)
        {
            ...
            define('CONSUMER_KEY', 'ww3IiVV46SRmbIstw8fyQ');
            define('CONSUMER_SECRET', 'Ibj7baGS8KomashZsqCIrcjOLeDLc0KIHpY95wgdw');
            $connection = new TwitterOAuth(CONSUMER_KEY, CONSUMER_SECRET, '825745832-BeyyUIlHYeWrIwOHrb4mc5RN7jaV1tKh8nGJIx5v', 'aBx7azDqcrdcuU5wRh9gSsFNA2Spll8S0JiIWGKjvM');
            // Fetch data
            $connection->host = self::TWITTER_API_BASE;
            $result = $connection->get('users/show', array('screen_name' => $twitterId));
        ...
        public static function getGooglePlusData($googlePlusId, $urlIdentifier)
        {
            ...
            /* Fetch data */
            $result = wp_remote_get(self::GOOGLEPLUS_API_BASE . $googlePlusId . '?key=AIzaSyBvEhfjZyheh-yw7t1VNzNXeOzBondttiY');
            ...
            if(!is_array($data) or !isset($data['plusOneCount'])){
                return false;
            }
        ...
        public static function getFeedburnerData($feedburnerId)
        {
            ...
            /* Return subscribers count */
            return false; // (int) $data->feed->entry['circulation'];
